...
class Offer implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets offer_status
     *
     * @param string|null $offer_status The current state, or status, of an offer. Status states include PENDING, COUNTERED, ACCEPTED, and DECLINED. For implementation help, refer to <a href='https://developer.ebay.com/devzone/rest/api-ref/negotiation/types/OfferStatusEnum.html'>eBay API documentation</a>
     *
     * @return self
     */
     ...
     * Sets offer_type
     *
     * @param string|null $offer_type The type of offer being made. For implementation help, refer to <a href='https://developer.ebay.com/devzone/rest/api-ref/negotiation/types/OfferTypeEnum.html'>eBay API documentation</a>
     *
     * @return self
     */
